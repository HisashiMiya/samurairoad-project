(() => {
  ...
  const DICT = {
    ja: {
      ...
      title_settings: "設定", title_trace: "なぞりゲーム", title_routeedit: "ルート作成", re_target: "参照", re_status: "状態", re_rule: "使い方", re_rule_text: "描画開始後、地図上を押しながらなぞって線を作成します。保存するとGeoJSONを書き出します。", re_start: "描画開始", re_undo: "1つ戻す", re_reset: "全消去", re_finish: "描画を確定", re_save: "保存", re_export: "保存", re_save_exit: "保存して終了", re_draw_help: "地図を押したままなぞって線を引きます。地図を動かしたいときは下のチェックをONにしてください。", re_showref: "参照ルートを表示", re_snap: "参照ルートへスナップ（近い時だけ）", re_name: "ルート名", re_note: "メモ・説明", re_result: "プレビュー", re_simplify: "線をなめらかに整える", re_tolerance: "補正の強さ", re_vertex_edit: "頂点を後から修正する", re_section_basic: "基本情報", re_section_basic_saved: "保存するGeoJSONに入る情報", re_basic_help: "ルート名は properties.name、メモ・説明は properties.note に保存されます。", re_section_assist: "表示・補助", re_section_main: "メイン操作", re_section_details: "詳細設定", re_section_file: "ファイル操作", re_section_output: "保存・終了", re_status_idle: "", re_status_drawing: "描画中です", re_panel_close: "パネルを閉じる", re_mode_exit: "作成モードを終了", re_import: "GeoJSON / GPX を読み込む", re_cancel: "キャンセル", re_drawing_now: "描画中です", re_name_placeholder: "例：中山道（妻籠→馬籠）", re_note_placeholder: "例：現地でなぞった復元版", trace_target: "お題", trace_best: "自己ベスト", trace_rule: "ルール", trace_rule_text: "赤いルートに近いほど高得点。塗りつぶし（描きすぎ）は減点。", trace_start: "スタート", trace_reset: "リセット", trace_submit: "採点", trace_hint: "お題を表示（ヒント）", trace_panzoom: "描画中も地図操作を許可", trace_result: "結果", trace_score: "スコア", lbl_lang: "言語 / Language", lbl_wakelock: "画面常時点灯", lbl_autospeech: "自動読み上げ (AI)",
      btn_usage: "使い方ガイド",
    ...
    en: {
      ...
      title_settings: "Settings", title_trace: "Trace Game", title_routeedit: "Route Editor", re_target: "Reference", re_status: "Status", re_rule: "How to use", re_rule_text: "After tapping Start Drawing, press and trace on the map to create a line. Save writes a GeoJSON file.", re_start: "Start Drawing", re_undo: "Undo", re_reset: "Clear Current Line", re_finish: "Confirm Drawing", re_save: "Save", re_export: "Save", re_save_exit: "Save and Exit", re_draw_help: "Press and trace on the map to draw a line. Turn on the checkbox below when you want to move the map.", re_showref: "Show reference route", re_snap: "Snap to reference route (only when close)", re_name: "Route Name", re_note: "Notes / Description", re_result: "Preview", re_simplify: "Smooth the line", re_tolerance: "Adjustment strength", re_vertex_edit: "Edit vertices afterward", re_section_basic: "Basic Info", re_section_basic_saved: "Information saved in GeoJSON", re_basic_help: "Route Name is saved to properties.name and Notes / Description to properties.note.", re_section_assist: "Display & Assistance", re_section_main: "Main Action", re_section_details: "Advanced Settings", re_section_file: "File Actions", re_section_output: "Save & Exit", re_status_idle: "", re_status_drawing: "Drawing in progress", re_panel_close: "Close Panel", re_mode_exit: "Exit Route Editor", re_import: "Import GeoJSON / GPX", re_cancel: "Cancel", re_drawing_now: "Drawing in progress", re_name_placeholder: "Example: Nakasendo (Tsumago → Magome)", re_note_placeholder: "Example: traced on site and restored", lbl_lang: "Language", lbl_wakelock: "Keep Screen On", lbl_autospeech: "Auto Speech (AI)",
